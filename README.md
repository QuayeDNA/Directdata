# Directdata — Telecom Storefront & Dashboard

React 19 + TypeScript + Vite storefront and management dashboard for the Directdata brand.
...
Set `VITE_STORE_ONLY=true` to run as a pure storefront.
