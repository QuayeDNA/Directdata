...
import {
  ...
  DirectDataSvgIcon,
} from "../components/common/DirectDataSvgLogo";
import {
  ArrowRight,
  Check,
  Menu,
...
export const LandingPage: FC = () => {
  ...
  useEffect(() => {
    document.title = "DirectData — Telecom Platform";
  }, []);
        ...
        <Container>
          <div className="flex justify-between items-center h-16 sm:h-[var(--header-height)]">
            <Link to="/home" className="flex-shrink-0">
              <DirectDataSvgLogoCompact width={38} height={42} />
            </Link>
      ...
      >
        <Container>
          <SectionHeader
            ...
            subtitle="From airtime top-ups to data bundles — DirectData handles it all so you can focus on growing."
          />
      ...
      <Section background="white" padding="lg">
        <Container>
          <SectionHeader
            ...
            subtitle="Four steps to start earning with DirectData."
          />
                ...
                >
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                      <DirectDataSvgIcon width={32} height={32} />
                      <div>
                        <div
      ...
      >
        <Container>
          <SectionHeader
            ...
            subtitle="Whether you're a solo agent or managing an entire distribution network — DirectData scales with you."
          />
      ...
      >
        <Container>
          <SectionHeader
            ...
            subtitle="Real stories from real people building real businesses on DirectData."
          />
