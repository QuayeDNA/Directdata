...
import { 
  DirectDataSvgLogo, 
  DirectDataSvgLogoCompact, 
  DirectDataSvgIcon 
} from './DirectDataSvgLogo';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-200 mb-8">
          ...
          <div className="flex justify-center items-center">
            <DirectDataSvgLogo width={120} height={140} />
          </div>
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-200 mb-8">
          ...
          <div className="flex justify-center items-center">
            <DirectDataSvgLogoCompact width={200} height={50} />
          </div>
          <div className="mt-4 text-sm text-gray-500 text-center">
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-200 mb-8">
          ...
          <div className="flex justify-center items-center space-x-8">
            <div className="text-center">
              <DirectDataSvgIcon width={40} height={40} />
              <div className="mt-2 text-sm text-gray-500">40x40px</div>
            </div>
            <div className="text-center">
              <DirectDataSvgIcon width={64} height={64} />
              <div className="mt-2 text-sm text-gray-500">64x64px</div>
            </div>
            <div className="text-center">
              <DirectDataSvgIcon width={96} height={96} />
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-100 p-4 rounded-lg">
              <div className="flex items-center justify-between">
                <DirectDataSvgLogoCompact width={140} height={40} />
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-100 p-4 rounded-lg max-w-md">
              <div className="flex items-center space-x-3">
                <DirectDataSvgIcon width={48} height={48} />
                <div>
                  <div className="font-medium text-gray-900">DirectData</div>
          ...
          <div className="space-y-4 text-sm font-mono">
            <div>
              ...
              <div className="text-green-300">
                import {`{ DirectDataSvgLogo, DirectDataSvgLogoCompact, DirectDataSvgIcon }`} from './components/common';
              </div>
            </div>
            <div>
              <div className="text-blue-300 mb-1">// Use in your components</div>
              <div className="text-yellow-300">&lt;DirectDataSvgLogo width={`{120}`} height={`{140}`} /&gt;</div>
              <div className="text-yellow-300">&lt;DirectDataSvgLogoCompact width={`{180}`} height={`{50}`} /&gt;</div>
              <div className="text-yellow-300">&lt;DirectDataSvgIcon width={`{40}`} height={`{40}`} /&gt;</div>
            </div>
          </div>
        </div>
      </div>
